...
const (
	...
	Tasks_SubmitTask_FullMethodName = "/tasks.Tasks/SubmitTask"
)
...
type TasksClient interface {
	GetTask(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskData, error)
	SubmitTask(ctx context.Context, in *TaskSubmit, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *tasksClient) GetTask(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskData, error) {
...
func (c *tasksClient) SubmitTask(ctx context.Context, in *TaskSubmit, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Tasks_SubmitTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TasksServer interface {
	GetTask(context.Context, *Empty) (*TaskData, error)
	SubmitTask(context.Context, *TaskSubmit) (*Empty, error)
...
func (UnimplementedTasksServer) GetTask(context.Context, *Empty) (*TaskData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTask not implemented")
}
func (UnimplementedTasksServer) SubmitTask(context.Context, *TaskSubmit) (*Empty, error) {
...
func _Tasks_GetTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TasksServer).GetTask(ctx, req.(*Empty))
	}
...
func _Tasks_SubmitTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tasks_SubmitTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TasksServer).SubmitTask(ctx, req.(*TaskSubmit))
	}
	return interceptor(ctx, in, info, handler)
}
